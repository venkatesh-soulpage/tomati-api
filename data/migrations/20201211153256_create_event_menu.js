exports.up = function (knex) {
  return knex.schema.createTable("outleteventmenus", (table) => {
    ...
    table.integer("outlet_event_id").references("outletevents.id");
...
exports.down = function (knex) {
  return knex.schema.dropTable("outleteventmenus");
};
